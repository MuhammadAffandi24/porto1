      ...
      <div className="container mx-auto px-6 py-6">
        <div className="flex items-center justify-between">
          <motion.h1
            ...
            className="text-xl tracking-wider bg-gradient-to-r from-accent via-accent to-secondary bg-clip-text text-transparent"
          >
            PORTOFOLIO
          </motion.h1>
            ...
            {navItems.map((item, index) => {
              return (
                <motion.button
                  ...
                  className={`px-6 py-2 text-sm tracking-wide transition-all rounded-full ${
