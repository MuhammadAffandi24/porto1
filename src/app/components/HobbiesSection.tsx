      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        <div className="text-center mb-12 md:mb-16">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="section-heading text-3xl sm:text-4xl md:text-6xl font-bold bg-gradient-to-r from-white via-white to-[#FFD700] bg-clip-text text-transparent pb-2 mb-4"
          >
            Hobi & Minat
          </motion.h2>
          <motion.div
