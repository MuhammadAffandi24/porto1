  ...
  return (
    <section className="relative py-24 sm:py-36 md:py-48 px-4 sm:px-6 overflow-hidden bg-[#050505]">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -right-10 w-[600px] h-[600px] bg-[#4a1a1e]/40 rounded-full blur-[140px]" />
        <div className="absolute bottom-1/4 -left-10 w-[600px] h-[600px] bg-[#1a233a]/40 rounded-full blur-[120px]" />
      </div>
