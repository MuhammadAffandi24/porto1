              ...
              >
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    ...
                    {/* Job Title */}
                    <h3 className="text-2xl font-bold text-white mb-1 leading-tight group-hover:text-[#ffd700]/90 transition-colors">
                      {exp.title}
                    </h3>

                    {/* Company Name */}
                    <p className="text-sm font-bold text-[#ffd700]/80 mb-4 tracking-wide">
                      {exp.company}
                    </p>
